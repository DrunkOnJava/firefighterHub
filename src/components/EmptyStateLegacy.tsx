...
export function EmptyStateLegacy({
  title,
  description,
  icon,
  action,
...
export function NoFirefightersEmptyStateLegacy({
  onAddFirefighter,
  isAdminMode = false,
...
export function NoScheduledHoldsEmptyStateLegacy({
  onScheduleHold,
  isAdminMode = false,
...
export function NoSearchResultsEmptyStateLegacy({
  searchTerm,
  onClearSearch,
...
export function ConnectionErrorEmptyStateLegacy({
  onRetry,
...
export function NoDeactivatedFirefightersEmptyStateLegacy() {
  return (
    <EmptyStateLegacy
...
export function NoActivityEmptyStateLegacy() {
  return (
    <EmptyStateLegacy
...
export function NoReportsDataEmptyStateLegacy() {
  return (
    <EmptyStateLegacy
