import { X, HelpCircle, Clock, UserPlus, Sun, Moon, Shield, Lightbulb } from 'lucide-react';
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className={`border-b-2 p-5 flex items-center justify-between ${
            ...
            <div>
              <h2 id="mobile-nav-title" className={`text-xl font-bold ${
                isDarkMode ? 'text-white' : 'text-slate-900'
              }`}>Menu</h2>
              {isAdminMode && (
                <div className="flex items-center gap-1.5 mt-1">
                  <Shield size={12} className={isDarkMode ? 'text-blue-400' : 'text-blue-600'} />
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-6">
            ...
            <section>
              ...
              <div className="space-y-2">
                ...
                >
                  <Clock size={22} className={isDarkMode ? 'text-blue-400' : 'text-blue-600'} />
                  <div>
                ...
                >
                  <HelpCircle size={22} className={isDarkMode ? 'text-purple-400' : 'text-purple-600'} />
                  <div>
                    <div className={`font-semibold ${
                      isDarkMode ? 'text-white' : 'text-slate-900'
                    }`}>Help & Guide</div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <div className={`text-sm ${
                      isDarkMode ? 'text-gray-400' : 'text-slate-600'
                    }`}>{isDarkMode ? 'Dark mode' : 'Light mode'}</div>
                  </div>
                </div>
              ...
              <section className="pt-4 border-t-2">
                <div className={`border rounded-lg p-4 ${
                  ...
                  <h3 className={`font-semibold mb-2 flex items-center gap-2 ${
                    ...
                    <Lightbulb className={`w-4 h-4 ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`} />
                    Quick Tip
                  </h3>
                  <p className={`text-sm ${
