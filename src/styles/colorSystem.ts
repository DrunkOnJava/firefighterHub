...
export const colors = {
  ...
  components: {
    /** Button styles */
    button: {
      primary: 'bg-gradient-to-br from-red-600 to-rose-700 hover:from-red-500 hover:to-rose-600 text-white shadow-lg shadow-red-900/50 transition-all duration-150',
      secondary: 'bg-slate-700 hover:bg-slate-600 text-gray-100 border border-slate-600 transition-all duration-150',
      danger: 'bg-gradient-to-br from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white shadow-lg shadow-red-900/50 transition-all duration-150',
      success: 'bg-gradient-to-br from-emerald-600 to-green-700 hover:from-emerald-500 hover:to-green-600 text-white shadow-lg shadow-emerald-900/50 transition-all duration-150',
      ghost: 'bg-transparent hover:bg-slate-700 text-gray-300 transition-all duration-150',
    },
    
    /** Input field styles */
    input: {
      default: 'bg-slate-800 border border-slate-600 text-gray-100 placeholder-gray-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-150',
      error: 'bg-slate-800 border border-red-500 text-gray-100 focus:border-red-500 focus:ring-2 focus:ring-red-500/20 transition-all duration-150',
    ...
    card: {
      ...
      hover: 'bg-gray-800 border border-gray-700 hover:border-gray-600 hover:shadow-lg transition-all duration-150',
