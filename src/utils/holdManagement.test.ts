...
describe('Hold Management System', () => {
  describe('1. Rotation Logic - Hold Assignment', () => {
    it('R1.1: Next available firefighter should be at position 0', () => {
      const firefighters = [
        ...
        createMockFirefighter({ id: '3', order_position: 2, is_available: true, name: 'Third' }),
      ];
    ...
    it('R1.4: Rotation respects order_position sorting', () => {
      const firefighters = [
        createMockFirefighter({ id: '3', order_position: 10, is_available: true, name: 'Third' }),
        createMockFirefighter({ id: '1', order_position: 2, is_available: true, name: 'First' }),
        createMockFirefighter({ id: '2', order_position: 5, is_available: true, name: 'Second' }),
      ];
  ...
  describe('2. Calendar Entries - Hold Scheduling', () => {
    ...
    it('R2.2: Auto-schedule rotates through available firefighters', () => {
      const firefighters = [
        createMockFirefighter({ id: '1', order_position: 0, is_available: true, name: 'A' }),
        createMockFirefighter({ id: '2', order_position: 1, is_available: true, name: 'B' }),
        createMockFirefighter({ id: '3', order_position: 2, is_available: true, name: 'C' }),
      ];
  ...
  describe('7. Rotation Edge Cases', () => {
    ...
    it('R7.5: Reactivating firefighter and recalculating positions', () => {
      const firefighters = [
        createMockFirefighter({ id: '1', order_position: 0, is_available: true }),
        createMockFirefighter({ id: '2', order_position: 1, is_available: true }),
        createMockFirefighter({ id: '3', order_position: 2, is_available: false }),
      ];
      ...
      const reactivated = firefighters.map(ff =>
        ff.id === '3' ? { ...ff, is_available: true, order_position: 0 } : 
        ff.id === '1' ? { ...ff, order_position: 1 } :
        ff.id === '2' ? { ...ff, order_position: 2 } : ff
      );
