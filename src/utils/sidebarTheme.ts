    ...
    return {
      ...
      rotation: {
        nextUp: {
          ...
          numberBadge: 'bg-red-600 text-white shadow-lg shadow-red-900/50',
          name: 'text-slate-50',
          badge: 'bg-red-600 text-white',
        },
        others: {
          background: 'bg-slate-900/50 border-slate-700',
          numberBadge: 'bg-slate-700 text-slate-300',
          name: 'text-slate-300',
        },
      },
    };
  ...
  return {
    ...
    rotation: {
      nextUp: {
        ...
        numberBadge: 'bg-red-600 text-white',
        name: 'text-slate-900',
        badge: 'bg-red-600 text-white',
      },
      others: {
        background: 'bg-slate-100 border-slate-300',
        numberBadge: 'bg-slate-300 text-slate-700',
        name: 'text-slate-700',
      },
    },
  };
